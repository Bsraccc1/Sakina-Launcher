...
//    const val THEME_MODE_SYSTEM = 2
    ...
    const val URL_ABOUT_SAKINA = "https://tanujnotes.substack.com/p/olauncher-minimal-af-launcher?utm_source=sakina"
    const val URL_SAKINA_PRIVACY = "https://tanujnotes.notion.site/Olauncher-Privacy-Policy-dd6ac5101ddd4b3da9d27057889d44ab"
    const val URL_DOUBLE_TAP = "https://tanujnotes.notion.site/Double-tap-to-lock-Olauncher-0f7fb103ec1f47d7a90cdfdcd7fb86ef"
    const val URL_SAKINA_GITHUB = "https://www.github.com/tanujnotes/Olauncher"
    const val URL_SAKINA_PLAY_STORE = "https://play.google.com/store/apps/details?id=app.olauncher"
    const val URL_SAKINA_PRO = "https://play.google.com/store/apps/details?id=app.prolauncher"
    ...
    const val URL_DIGITAL_WELLBEING_LEARN_MORE = "https://tanujnotes.substack.com/p/digital-wellbeing-app-on-android?utm_source=sakina"
