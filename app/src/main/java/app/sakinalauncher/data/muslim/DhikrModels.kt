...
object DhikrContent {
    ...
    private val sharedCards = listOf(
        DhikrCard(
            ...
            arabic = "اللَّهُ لَا إِلَـٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ، لَا تَأْخُذُهُ سِنَةٌ وَلَا نَوْمٌ، لَهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الْأَرْضِ، مَنْ ذَا الَّذِي يَشْفَعُ عِنْدَهُ إِلَّا بِإِذْنِهِ، يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ، وَلَا يُحِيطُونَ بِشَيْءٍ مِنْ عِلْمِهِ إِلَّا بِمَا شَاءَ، وَسِعَ كُرْسِيُّهُ السَّمَاوَاتِ وَالْأَرْضَ، وَلَا يَئُودُهُ حِفْظُهُمَا، وَهُوَ الْعَلِيُّ الْعَظِيمُ",
            latin = "Allahu la ilaha illa huwal-hayyul-qayyum. La ta'khudzuhu sinatuw wa la naum. Lahu ma fis-samawati wa ma fil-ard. Man dzalladzi yasyfa'u 'indahu illa bi idznih. Ya'lamu ma bayna aydihim wa ma khalfahum. Wa la yuhithuna bi syai-im min 'ilmihi illa bi ma sya'. Wasi'a kursiyyuhus-samawati wal-ard. Wa la ya-uduhu hifzhuhuma wa huwal-'aliyyul-'azhim.",
        ...
        DhikrCard(
            ...
            latin = "Bismillahir-rahmanir-rahim. Qul a'udzu birabbil-falaq. Min sharri ma khalaq. Wa min sharri ghasiqin idza waqab. Wa min sharrin-naffatsati fil-'uqad. Wa min sharri hasidin idza hasad.",
        ...
        DhikrCard(
            ...
            latin = "Bismillahir-rahmanir-rahim. Qul a'udzu birabbin-nas. Malikin-nas. Ilahin-nas. Min sharril-waswasil-khannas. Alladzi yuwaswisu fi sudurin-nas. Minal-jinnati wan-nas.",
        ...
        DhikrCard(
            ...
            latin = "Allahumma anta rabbi la ilaha illa anta, khalaqtani wa ana 'abduka, wa ana 'ala 'ahdika wa wa'dika mastata't, a'udzu bika min sharri ma sana't, abu-u laka bini'matika 'alayya, wa abu-u bi dzanbi, faghfir li, fa innahu la yaghfirudz-dzunuba illa anta.",
        ...
        DhikrCard(
            ...
            latin = "Allahumma 'afini fi badani, allahumma 'afini fi sam'i, allahumma 'afini fi basari, la ilaha illa anta. Allahumma inni a'udzu bika minal-kufri wal-faqr, wa a'udzu bika min 'adzabil-qabr, la ilaha illa anta.",
        ...
        DhikrCard(
            ...
            latin = "Allahumma inni as-alukal-'afwa wal-'afiyata fid-dunya wal-akhirah. Allahumma inni as-alukal-'afwa wal-'afiyata fi dini wa dunyaya wa ahli wa mali. Allahummastur 'awrati wa amin raw'ati. Allahummahfazhni min bayni yadayya, wa min khalfi, wa 'an yamini, wa 'an syimali, wa min fawqi, wa a'udzu bi 'azhamatika an ughtala min tahti.",
        ...
        DhikrCard(
            ...
            latin = "Allahumma 'alimal-ghaybi wash-shahadah, fatiras-samawati wal-ard, rabba kulli syai-in wa malikah, asyhadu an la ilaha illa anta, a'udzu bika min syarri nafsi, wa min syarrisy-syaithani wa syirkih, wa an aqtarifa 'ala nafsi su-an aw ajurrahu ila muslim.",
    ...
    private val morningOnlyCards = listOf(
        DhikrCard(
            ...
            latin = "Asbahna wa asbahal-mulku lillah, walhamdu lillah, la ilaha illallahu wahdahu la syarika lah, lahul-mulku wa lahul-hamd, wa huwa 'ala kulli syai-in qadir. Rabbi as-aluka khayra ma fi hadzal-yaum wa khayra ma ba'dah, wa a'udzu bika min syarri ma fi hadzal-yaum wa syarri ma ba'dah. Rabbi a'udzu bika minal-kasali wa su-il kibar. Rabbi a'udzu bika min 'adzabin fin-nar wa 'adzabin fil-qabr.",
        ...
        DhikrCard(
            ...
            latin = "Asbahna 'ala fitratil-islam, wa 'ala kalimatil-ikhlas, wa 'ala dini nabiyyina Muhammadin sallallahu 'alayhi wa sallam, wa 'ala millati abina Ibrahima, hanifan musliman, wa ma kana minal-musyrikin.",
    ...
    private val eveningOnlyCards = listOf(
        DhikrCard(
            ...
            latin = "Amsayna wa amsal-mulku lillah, walhamdu lillah, la ilaha illallahu wahdahu la syarika lah, lahul-mulku wa lahul-hamd, wa huwa 'ala kulli syai-in qadir. Rabbi as-aluka khayra ma fi hadzihil-laylah wa khayra ma ba'daha, wa a'udzu bika min syarri ma fi hadzihil-laylah wa syarri ma ba'daha. Rabbi a'udzu bika minal-kasali wa su-il kibar. Rabbi a'udzu bika min 'adzabin fin-nar wa 'adzabin fil-qabr.",
        ...
        DhikrCard(
            ...
            latin = "Amsayna 'ala fitratil-islam, wa 'ala kalimatil-ikhlas, wa 'ala dini nabiyyina Muhammadin sallallahu 'alayhi wa sallam, wa 'ala millati abina Ibrahima, hanifan musliman, wa ma kana minal-musyrikin.",
